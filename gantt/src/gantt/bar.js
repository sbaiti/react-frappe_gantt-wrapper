...
export default class Bar {
  ...
  compute_start_end_date() {
    ...
    const new_start_date = date_utils.add(
      ...
      (x_in_units + 1) * this.gantt.options.step,
      'hour'
    );
    const width_in_units = bar.getWidth() / this.gantt.options.column_width;
    const new_end_date = date_utils.add(
      new_start_date,
      (width_in_units - 1) * this.gantt.options.step,
      'hour'
    );
    console.log('column_width', this.gantt.options.column_width);
    console.log('new_start_date', new_start_date);
    console.log('new_end_date', new_end_date);
    console.log('width_in_units', width_in_units);
    console.log('this.gantt.options.step', this.gantt.options.step);
